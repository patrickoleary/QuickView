...
changes the button to a shield icon and reduce the displayed list to
...
![color invert on/off](./screenshots/invert_color_icons.png){ width="20%", align=right }
...
![linear and log](./screenshots/linear_log_icons.png){ width="20%", align=right }

## Automatic or fixed data ranges

![auto or fixed ranges](./screenshots/auto_or_fixed_ranges.png){ width="50%", align=right }
