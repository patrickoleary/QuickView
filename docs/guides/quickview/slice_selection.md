...
QuickView is designed to display one global or regional map at a time.

To choose the indices to use for the non-horizontal dimensions,
the slice selection button in the vertical tool bar can be used
...
- a drop-down menu for choosing a dimension to inspect,
